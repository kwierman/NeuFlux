/*!
	\file PhotonEnergyPerNeutronEnergy.C
	This is a basic analysis to pull out the mean photon energy per incumbant neutron energy

	Output of this will contain a histogram for every
*/


void PhotonEnergyPerNeutronEnergy(TString input="NeuFlux_XXXX_")
{
